...
<body>
	...
	<br />
	<a href="/jsp20230327/ch07/lecture/04path/05path.jsp">절대경로1 : /jsp20230327/ch07/lecture/04path/05path.jsp </a>
	<br />
	
	<!-- http://localhost:8080/jsp20230327/ch07/lecture/05path.jsp -->
	<a href="../05path.jsp">상대경로2 : ../05path.jsp</a>
	<br />
	<a href="/jsp20230327/ch07/lecture/05path.jsp">절대경로2 :/jsp20230327/ch07/lecture/05path.jsp</a>
	<br />
	
	<!-- http://localhost:8080/jsp20230327/ch07/05path.jsp -->
	<a href="../../05path.jsp">상대경로3 : ../../05path.jsp</a>
	<br />
	<a href="/jsp20230327/ch07/05path.jsp">절대경로3 : /jsp2/05path.jsp</a>
	<br />
